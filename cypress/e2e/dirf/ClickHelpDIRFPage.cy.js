...
describe('login br',() => {
    ...
    it("ClickHelpDIRFPage",()=>{
       
        cy.visit('https://www.mercadopago.com.br/balance/reports/dirf')
        cy.wait(waitLoadPage)
        cy.get('.andes-message__text > a').invoke('removeAttr', 'target').click()
        cy.wait(waitLoadPage)
        cy.get('.cx-peach-content__title').should('have.text','Quais informações o informe apresenta')
        cy.url().should('include', 'https://www.mercadopago.com.br/ajuda/27547')
